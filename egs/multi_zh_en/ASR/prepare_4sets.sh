...
if [ $stage -le 3 ] && [ $stop_stage -ge 3 ]; then
  log "Stage 3: Prepare GigaSpeech"
  if [ -e ../../gigaspeech/ASR/data/fbank/.preprocess_complete ]; then
    cd data/fbank
    ln -svf $(realpath ../../../../gigaspeech/ASR/data/fbank/cuts_DEV.jsonl.gz) .
    ...
    log "Abort! Please run ../../gigaspeech/ASR/prepare.sh"
    exit 1
  fi
fi
...
if [ $stage -le 4 ] && [ $stop_stage -ge 4 ]; then
  log "Stage 4: Prepare CommonVoice"
  if [ -e ../../commonvoice/ASR/data/fbank/.preprocess_complete ]; then
    cd data/fbank

    ln -svf $(realpath ../../../../commonvoice/ASR/data/en/fbank/cv-en_cuts_dev.jsonl.gz) .
    ln -svf $(realpath ../../../../commonvoice/ASR/data/en/fbank/cv-en_cuts_test.jsonl.gz) .
    ...
    ln -svf $(realpath ../../../../commonvoice/ASR/data/en/fbank/*.lca) .
    ln -svf $(realpath ../../../../commonvoice/ASR/data/en/fbank/) ./commonvoice
    cd ../..
  else
    log "Abort! Please run ../../commonvoice/ASR/prepare.sh"
    exit 1
  fi
fi
...
if [ $stage -le 5 ] && [ $stop_stage -ge 5 ]; then
  ...
  for vocab_size in ${vocab_sizes[@]}; do
    ...
    ln -svf data/lang_bpe_500/transcript_words.txt $lang_dir/text
